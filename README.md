...
- [x] Fork & clone the starter code
- [x] Install dependencies (`npm install`)
- [x] Start the app (`npm start`)
- [x] Check out the demo app at http://localhost:5000
- [x] Look through the code that has been provided to you!
